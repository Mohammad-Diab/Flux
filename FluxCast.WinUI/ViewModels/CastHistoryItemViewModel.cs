...
public partial class CastHistoryItemViewModel : ObservableObject
{
    ...
    /// <summary>Gets whether the source was a folder; the row icon picks between the two shapes.</summary>
    public bool IsFolder => Entry.SourceKind == SourceKind.Folder;

    /// <summary>Gets whether the source was a single file.</summary>
